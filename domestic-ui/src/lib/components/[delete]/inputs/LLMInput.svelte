...
<form onsubmit={e => {
	...
	<textarea bind:value={prompt} name="prompt" placeholder="Enter your prompt for the LLM" class="w-full h-48 {disabled ? 'bg-gray-dark' : 'bg-white'}" disabled={disabled}></textarea>
